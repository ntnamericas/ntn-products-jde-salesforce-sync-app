...
IBLTLV_IBLITM AS (
    ...
    WHERE (TRIM(TT1.IBUPMJ) >= 124348 AND TRIM(TT1.IBTDAY) >= 140256)
),
...
MIN(T5.MIN_IBLTLV) AS MIN_IBLTLV_SRTX,
MAX(T5.MAX_IBLTLV) AS MAX_IBLTLV_SRTX
...
WHERE (TRIM(T1.IBUPMJ) >= 124348 AND TRIM(T1.IBTDAY) >= 140256)
